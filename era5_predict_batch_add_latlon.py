...
outpath=f'/proj/bolinc/users/x_sebsc/nn_reanalysis/eval/{nettype}_latlon_{resolution}/'
...
for i, data in enumerate(dataset):
    ...
    fc_xr.to_netcdf(f'{outpath}/fc_{nettype}_latlon_{resolution}_itrain{i_train}_{t_init_adjusted.strftime("%Y%m%d%H")}.nc')
