...
"""
compute Southern Hemisphere RMSE per forecast (and per leadtime)
"""
...
# select only southern hemisphere

fcs = fcs.sel(lat=slice(-90,0))
...
res.to_pickle(f'data/fc_res_per_fc_SH_{nettype}_{resolution}_itrain{i_train}.pkl')
res.to_csv(f'data/fc_res__per_fc_SH_{nettype}_{resolution}_itrain{i_train}.csv')
